...
@JsonKey(name: 'tool_id') String get toolId;@JsonKey(name: 'tool_name') String get toolName;@JsonKey(name: 'tool_description') String get toolDescription;@JsonKey(name: 'tool_type', unknownEnumValue: AgentToolType.unknown) AgentToolType get toolType;/// Often a stringified JSON schema in your current data.
...
class _AgentTool implements AgentTool {
  const _AgentTool({@JsonKey(name: 'tool_id') required this.toolId, @JsonKey(name: 'tool_name') required this.toolName, @JsonKey(name: 'tool_description') required this.toolDescription, @JsonKey(name: 'tool_type', unknownEnumValue: AgentToolType.unknown) required this.toolType, @JsonKey(name: 'tool_parameters') this.toolParameters, @JsonKey(name: 'tool_query_template') this.toolQueryTemplate, @JsonKey(name: 'tool_python_code') this.toolPythonCode, @JsonKey(name: 'tool_system_message') this.toolSystemMessage, @JsonKey(name: 'tool_result_instructions') this.toolResultInstructions, @JsonKey(name: 'tool_action_endpoint') this.toolActionEndpoint, @JsonKey(name: 'tool_action_method') this.toolActionMethod, @FlexibleBoolConverter()@JsonKey(name: 'tool_requires_confirmation') this.toolRequiresConfirmation, @FlexibleIntConverter()@JsonKey(name: 'tool_order') required this.toolOrder});
...
@override@JsonKey(name: 'tool_type', unknownEnumValue: AgentToolType.unknown) final  AgentToolType toolType;
...
@override@JsonKey(name: 'status', unknownEnumValue: AgentStatus.unknown) final  AgentStatus status;
